exports.run = async (bot, msg, suffix) => {
	if (!msg.member.roles.get("259858538308960257") || !msg.member.roles.get("259847832121507843")) return msg.reply(`you don't have permission to run this command`).then(m => m.delete(10 * 100));
